...
import { SALPYEO_POST_FACILITY_ENRICHMENTS } from '@/salpyeo/facility/domain/constant/salpyeo-post-facility-enrichment.constant';
...
/**
 * 시설 시드 = 공공데이터 + 조리원 공식 홈페이지 보강. 현재는 산후조리원(보건복지부 전국 산후조리원 현황 2023-12-31) 456건.
 ...
 */
export const SALPYEO_FACILITY_SEED: readonly SalpyeoFacilitySeed[] = buildPostFacilitySeed(SALPYEO_POST_FACILITY_RECORDS, SALPYEO_POST_FACILITY_ENRICHMENTS);

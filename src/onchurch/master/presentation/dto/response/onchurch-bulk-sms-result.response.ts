...
import { OnchurchSmsRecipientResult, OnchurchSmsRecipientStatus } from '@/onchurch/master/domain/entity/onchurch-sms-log.entity';
...
export class OnchurchBulkSmsResultResponse {
  ...
  @ApiProperty({ type: [BulkSmsRecipientResult], description: '수신자별 결과' }) results: BulkSmsRecipientResult[];

  constructor(result: BulkSmsResult) {

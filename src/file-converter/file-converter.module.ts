...
import { HwpConverterService } from './service/hwp-converter.service';
import { ImageProcessorService } from './service/image-processor.service';
import { AwsS3Service } from '@/aws/s3/aws-s3.service';

@Module({
  providers: [FileConverterService, PdfConverterService, HwpConverterService, ImageProcessorService, AwsS3Service],
